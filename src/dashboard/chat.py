...
def build_system_prompt(db_path: str) -> str:
    ...
    return (
        ...
        "CPR (Initiate Checkout) (= spend / meta_begin_checkout) is the North Star Metric — "
        "lower CPR (Initiate Checkout) is better. Always include CPR (Initiate Checkout) "
        "when discussing conversions. "
